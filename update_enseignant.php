  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    ...
    if($traitement){
        ...
        foreach($traitement as $row){
            ...
            echo'<form action="modifier_enseignant.php" method = "POST" >

            <table>
            <tr><th>matricule:</th><td>'.$row['matricule_enseignant'].'</td></tr>
            <tr><th>nom:</th><td>'.$row['nom'].'</td></tr>
            <tr><th>prenom:</th><td>'.$row['prenom'].'</td></tr>
            <tr><th>nombre de classe enseigné:</th><td><input type = "numeric" name="occupation" value="'.$row['nombre_de_classe_enseigne'].'"></td></tr>
            <tr><td colspan = "2"><input type="submit" name="submit" value="modifier" class="btn btn-primary"></td></tr>
            <table>
